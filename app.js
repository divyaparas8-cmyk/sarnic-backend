...
router.use("/api/s1", flavourRoute);
router.use("/api/s1", packtypeRoute);
router.use("/api/s1", subBrandRoute);
router.use("/api/s1", packcodeRoute);
router.use("/api/s1", roleRoute);
